            ...
            if(mainOptionsFoldout)
            {
                ...
                if(dmxSpawnsFoldout)
                {
                   ...
                   // EditorGUILayout.EndVertical();
                    ...
                    if(GUILayout.Button(Label("Vertical", "Spawn the vertical version of the USharp Video Player DMX Reader Screen. Use this video player prefab to stream DMX data to via Twitch/VRCDN! You can replace the video player in this prefab with any other video player you want as long as the screen gets duplicated to the larger plane!"), HalfButton()))
                    {
                    ...
                    if(GUILayout.Button(Label("Legacy", "Spawn the legacy version of the USharp Video Player DMX Reader Screen. Use this video player prefab to stream DMX data to via Twitch/VRCDN! You can replace the video player in this prefab with any other video player you want as long as the screen gets duplicated to the larger plane!"), HalfButton()))
                    {
